...
async fn test_post_create_transactions_common(address_version: Option<u64>) {
    ...
    let expected_response_body = match address_version {
        Some(NETWORK_VERSION_V0) => "{\"id\":\"2ae7bc9cba924e3cb73c0249893078d7\",\"status\":\"Success\",\"reason\":\"Transaction(s) processing\",\"route\":\"create_transactions\",\"content\":{\"g573ebb06a447bd4310b11491b452019\":[\"0008536e3d5a13e347262b5023963000\",{\"asset\":{\"Token\":1},\"extra_info\":null}]}}",
        Some(NETWORK_VERSION_TEMP) => "{\"id\":\"2ae7bc9cba924e3cb73c0249893078d7\",\"status\":\"Success\",\"reason\":\"Transaction(s) processing\",\"route\":\"create_transactions\",\"content\":{\"g42ae6e503e36072b35c37c2261289b5\":[\"0008536e3d5a13e347262b5023963000\",{\"asset\":{\"Token\":1},\"extra_info\":null}]}}",
        None => "{\"id\":\"2ae7bc9cba924e3cb73c0249893078d7\",\"status\":\"Success\",\"reason\":\"Transaction(s) processing\",\"route\":\"create_transactions\",\"content\":{\"gcf116a93528142bf78798314fa15045\":[\"0008536e3d5a13e347262b5023963000\",{\"asset\":{\"Token\":1},\"extra_info\":null}]}}",
        _ => Default::default()
    };
    assert_eq!(
